...
def('HOST', 'http://admin.test.compbet.com');
def('JSHOST', 'admin.test.compbet.com');
def('BASEDOMAIN', 'admin.test.compbet.com');

if (!defined('PROTOCOL')) define('PROTOCOL', 'https://'); //protocol stranek

def('WEBHOST', 'www.test.compbet.com/');
...
def('XML_RPC_HOST', 'www.test.compbet.com'); //host uzivatelskych stranek
