...
#Dalsi nastaveni#
if(!defined('WEB_ROOT')) define('WEB_ROOT',ROOT.'admin/www/'); //adresar

def('HOST', 'http://admin.testbook.cz');
def('JSHOST', 'admin.testbook.cz');
def('BASEDOMAIN', 'admin.testbook.cz');

if (!defined('PROTOCOL')) define('PROTOCOL', 'https://'); //protocol stranek

def('WEBHOST', 'www.testbook.cz/'); //host uzivatelskych stranek
...
#Bet Radar config#
if(!defined('EXPORT_URL')) define('EXPORT_URL',"https://www.betradar.com/betradar/getXmlFeed.php?bookmakerName=compbet&key=do34lp56FT&xmlFeedName=SourceJoin&deleteAfterTransfer=yes");     // url na betradaru pro zjisteni ids statistik a sparovani id sazek
...
def('XML_RPC_HOST', 'www.testbook.cz'); //host uzivatelskych stranek
