...
oWin.bordercolor="#C82128" //Remember that you have to change the images as well if you change this color
oWin.bgcolor="#989898" //Default background color
oWin.bgcoloron="#F3CE5B"  //The "active" background color
oWin.bgscroll="#EE9F00" //The background-color for the scroll area"
...
oWin.bottomh=17 //The height of the bottom "border"
...
function addWindow(heading,content,x,y,w,h,bg,bga){
	...
	str+='<div class="clLogo"><img alt="Window Script from DHTMLCentral.com" src="_clip/win_logo.gif"  alt="" border="0" align="top"></div>\n'
	...
	+'<div id="divWinButtons'+num+'" class="clWinButtons">\n'
		...
		+'</map>\n'
		+'<img usemap="#map'+num+'" alt="Window Script from DHTMLCentral.com"  src="_clip/buttons.gif" width="38" height="14" alt="" border="0">\n'
	+'</div>\n'
	...
	if(content){
		str+=content+'</div>\n'
		+'</div>\n'
		+'<div id="divWinUp'+num+'" class="clUp"><a href="#" onclick="return false" onmouseover="winScroll=1; oWin['+num+'].down();"  onmouseout="noScroll()"><img src="_clip/arrow_up.gif" width="11" height="12" alt="" border="0"></a></div>\n'
		+'<div id="divWinDown'+num+'" class="clDown"><a href="#" onclick="return false" onmouseover="winScroll=1; oWin['+num+'].up();" onmouseout="noScroll()"><img src="_clip/arrow_down.gif" width="11" height="12" alt="" border="0"></a></div>\n'
		+'</div>'
	}
	document.write(str)
