...
class Zend_Validate_NotEmpty extends Zend_Validate_Abstract
{
    ...
    const IS_EMPTY_TR = 'is_empty_value';
    const IS_ITYPE_TR = 'is_invalid_type_value';
    ...
    public function __construct($options = null)
    {
        ...
        //$this->_messageTemplates[self::IS_EMPTY] =$tr->trans(self::IS_EMPTY_TR);
        //$this->_messageTemplates[self::INVALID] = $tr->trans(self::IS_ITYPE_TR);
		$this->_messageTemplates[self::IS_EMPTY] = self::IS_EMPTY_TR;
        $this->_messageTemplates[self::INVALID] = self::IS_ITYPE_TR;
    }
