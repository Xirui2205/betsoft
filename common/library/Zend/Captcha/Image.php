...
class Zend_Captcha_Image extends Zend_Captcha_Word
{
   ...
   /**
    ...
    protected function _generateImage($id, $word)
    {
        ...
        $bg_color   = imagecolorallocate($img, 180, 180, 180);
        imagefilledrectangle($img, 0, 0, $w-1, $h-1, $bg_color);
        //IT6: fixed PHP bug of imageftbbox()
        $tries = 10;
        do {
           $textbox = imageftbbox($fsize, 0, $font, $word);
        } while ($tries-- && ($textbox[2] < $textbox[0] || $textbox[4] < $textbox[0]));
       ...
       // generate noise
        ...
        $bg_color = imagecolorallocate($img2, 214, 180, 106);
