  ...
  **/
	...
	class WideImage_Operation_RoundCorners
	{
		...
		function execute($image, $radius, $color, $smoothness, $corners)
		{
			...
			$corner = WideImage_WideImage::createTrueColorImage($radius * $sample_ratio, $radius * $sample_ratio);
			if ($color === null)
			{
				...
				if ($corners & WideImage_WideImage::SIDE_TOP_LEFT || $corners & WideImage_WideImage::SIDE_LEFT || $corners & WideImage_WideImage::SIDE_TOP)
					$result = $result->applyMask($corner, -1, -1);
				
				$corner = $corner->rotate(90);
				if ($corners & WideImage_WideImage::SIDE_TOP_RIGHT || $corners & WideImage_WideImage::SIDE_TOP || $corners & WideImage_WideImage::SIDE_RIGHT)
					$result = $result->applyMask($corner, $result->getWidth() - $corner->getWidth() + 1, -1, 100);
				
				$corner = $corner->rotate(90);
				if ($corners & WideImage_WideImage::SIDE_BOTTOM_RIGHT || $corners & WideImage_WideImage::SIDE_RIGHT || $corners & WideImage_WideImage::SIDE_BOTTOM)
					$result = $result->applyMask($corner, $result->getWidth() - $corner->getWidth() + 1, $result->getHeight() - $corner->getHeight() + 1, 100);
				
				$corner = $corner->rotate(90);
				if ($corners & WideImage_WideImage::SIDE_BOTTOM_LEFT || $corners & WideImage_WideImage::SIDE_LEFT || $corners & WideImage_WideImage::SIDE_BOTTOM)
