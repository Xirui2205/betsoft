 ...
 * @copyright 2007-2010
  ...
  **/
	...
	require_once WideImage_WideImage::path() . 'Exception.php';
	
	require_once WideImage_WideImage::path() . 'Image.php';
	require_once WideImage_WideImage::path() . 'TrueColorImage.php';
	require_once WideImage_WideImage::path() . 'PaletteImage.php';
	
	require_once WideImage_WideImage::path() . 'Coordinate.php';
	require_once WideImage_WideImage::path() . 'Canvas.php';
	require_once WideImage_WideImage::path() . 'MapperFactory.php';
	require_once WideImage_WideImage::path() . 'OperationFactory.php';
	
	require_once WideImage_WideImage::path() . 'Font/TTF.php';
	require_once WideImage_WideImage::path() . 'Font/GDF.php';
	require_once WideImage_WideImage::path() . 'Font/PS.php';
	...
	class WideImage_WideImage
	{
		...
		static function load($source, $format = null)
		{
			...
			return call_user_func(array('WideImage_WideImage', 'loadFrom' . $predictedSourceType), $source, $format);
		}			
