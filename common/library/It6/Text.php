...
/**
 * Creates safe string from general UTF-8 string.
 * Non-ASCII characters translated (if translatable), white space groups replaced by single dash,
 * remaining non-word characters are replaced by underscore if desired (and by default).
 * @param string $string String to convert
 * @param boolean|NULL $lowercase [optional] TRUE=lowercase (default), FALSE=uppercase, NULL=unmodified case
 * @param boolean $replaceNonLetters If TRUE non-letter characters will be replaced with undescored, will be preserved otherwise. TRUE is default.
 * @return string Converted string
 */
public static function safeString($string, $lowercase = true, $replaceNonLetters = true) {
	static $utf8table = array ("\xC3\x80" => "A", "\xC3\x81" => "A", "\xC3\x82" => "A", "\xC3\x83" => "A",
 ...
 * @param string $cc String in camel-case notation
 * @return string String in dashed notation
 */
...
/**
 * Convert string from dashed notation to camel-case notation
 * @param string $d String in dashed notation
 * @return string String in camel-case notation
 */
public static function dashedToCamelCase($d) {
