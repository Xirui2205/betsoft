<?php
class It6_Cron_Job_DailyReport extends It6_Cron_Job_Abstract {
	...
	public function execute(array $params = array(), &$errorMessage = null) {
		...
		$data_pdf["date"] = $yesterday;
		$data_pdf["type"] = It6_Models_Translator::translate('daily_total_report', self::LANG_ID, $db);
		...
		$params = array(
			...
			It6_Cron_Job_Email_ReportEmail::PARAM_SUBJECT => 'daily_total_report',
			...
			It6_Cron_Job_Email_ReportEmail::PARAM_FILENAME => 'daily_report.pdf',
