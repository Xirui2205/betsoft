...
//class MyLogger { function log($msg) { if (!empty($_COOKIE['DEBUGMIN'])) file_put_contents('/tmp/debug-min.log', strftime('%Y-%m-%d %H:%M:%S ') . "$msg\n", FILE_APPEND); } }
...
$_bewaRoot = dirname(dirname(dirname(dirname(__FILE__)))); // expecting to be in BBAS_ROOT/web/www/min/
$min_serveOptions['minApp']['allowDirs'] = array('//js', '//css', "$_bewaRoot/common/www/js", "$_bewaRoot/common/www/css");
