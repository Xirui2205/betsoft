...
$GLOBALS['MUZO_CONFIG'] = array(
	'defaultLang' => 'cs',
	'urlForRequest' => 'https://3dsecure.gpwebpay.com/rb/order.do',
	'urlForResponse' => array(
		'cs' => 'https://www.compbet.com/cs/deposit-feedback/muzo/',
		'en' => 'https://www.compbet.com/en/deposit-feedback/muzo/',
		'sk' => 'https://www.compbet.com/sk/deposit-feedback/muzo/',
	),
	'privateKeyFile' => ROOT.'common/ssl/muzo/victoria-tip.key',
	'privateKeyPassword' => 'eSp9TVnrXLru',
	'certificateFile' => ROOT.'common/ssl/muzo/muzo.signing_prod.cer'
);
...
def('GOOGLE_ANALYTICS_CODE', 'index/google-analytics.phtml');

//Google ad conversion code
def('GOOGLE_AD_CONVERSION_REGISTRATION', 'registration/google-ad-conversion-registration.phtml');
def('GOOGLE_AD_CONVERSION_DEPOSIT', 'deposit/google-ad-conversion-deposit.phtml');
def('GOOGLE_AD_CONVERSION_BET_PLACED', 'ajax/google-ad-conversion-bet-placed.phtml');

def('LAYOUT_PATH', ROOT.'web/application/views/layouts/');
def('GLOBAL_CACHE_ENABLED', 1);
...
def('MINIFY_PREFIX', 'min/f='); // used in <script> src attribute eg. src="/{MINIFY_PREFIX}js/main.js"
