...
<head>
	...
	<title>Casino – YourLogo.com – A Pure Joy from Betting!</title>
...
<body>
	...
	<main id="content" role="main">
		<div id="true-content" class="welcome">
			...
			<div id="welcome">
				<div class="wrapper">
					<p class="welcome-big animate-in" data-anim-type="bounce-in-left" data-anim-delay="450">Welcome in</p>
					<p class="welcome-big welcome-highlight animate-in" data-anim-type="bounce-in-right" data-anim-delay="900">Magic Casino</p>
			...
			<div class="boxes-4 boxes-center">
				<div class="container">
					<div class="box">
						<a href="casino_lobby.php">
							<h2>Roulette Games</h2>
							<div class="box-image"><img src="images/boxes/roulette_games.jpg" alt="Roulette Games"></div>
							<p>Enjoy 27 roulette games in our casino.<br><span class="btn">Show Games</span></p>
						</a>
					</div>
					<div class="box">
						<a href="casino_lobby.php">
							<h2>Premium Slots</h2>
							<div class="box-image"><img src="images/boxes/premium_slots.jpg" alt="Premium Slots"></div>
							<p>Enjoy 27 premium slots in our casino.<br><span class="btn">Show Games</span></p>
						</a>
					</div>
					<div class="box">
						<a href="casino_lobby.php">
							<h2>Video Games</h2>
							<div class="box-image"><img src="images/boxes/video_games.jpg" alt="Video Games"></div>
							<p>Enjoy 27 elite slots in our casino.<br><span class="btn">Show Games</span></p>
						</a>
					</div>
					<div class="box">
						<a href="casino_lobby.php">
							<h2>Card Games</h2>
							<div class="box-image"><img src="images/boxes/card_games.jpg" alt="Card Games"></div>
							<p>Enjoy 27 card games in our casino.<br><span class="btn">Show Games</span></p>
						</a>
					</div>
				</div>
			</div>
	...
	<div id="welcome-bg" class="animate-in slow-mo welcome-casino" data-anim-type="fade-in"></div>
