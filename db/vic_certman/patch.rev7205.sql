CREATE TABLE `vic_certman`.`database_patch` (
...
DELIMITER ;;
CREATE PROCEDURE `vic_certman`.`fn_test_database_patch`(rev VARCHAR(64))
BEGIN
 DECLARE patchId INT;
...
INSERT INTO `vic_certman`.`database_patch`(`revision`, `not_reapplicable`, `note`) VALUES
