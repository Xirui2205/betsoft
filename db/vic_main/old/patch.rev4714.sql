...
(8, 'user.deposit.card', 'Klient dotuje hráčské konto kartou.', '378', '999', NULL, '999', '324', '999', 0, 1, 0, 'user', '50.00', '10000.00', 'always', '8.00', '0.02', 1, 1, 'BNK', NULL),
(9, 'user.deposit.cash', 'Vklad peněz v hotovosti na pobočce\r\n', '211', '%hostId%', NULL, '999', '324', '999', 0, 0, 0, 'user', '100.00', '10000.00', 'never', NULL, NULL, 1, 0, 'POK', NULL),
...
(11, 'user.withdraw.cash', 'Výběr uživatele na pobočce v hotovosti', '324', '999', NULL, '999', '379', '999', 1, 1, 0, 'user', '-20000.00', '-100.00', 'never', NULL, NULL, 1, 1, 'INT', NULL),
(12, 'user.withdraw.bank', 'Výběr uživatele bankovním převodem', '324', '999', NULL, '999', '379', '999', 1, 0, 0, 'user', '-5000.00', '-100.00', 'always', '15.00', NULL, 1, 1, 'INT', NULL),
