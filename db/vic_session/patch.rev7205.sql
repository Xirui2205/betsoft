CREATE TABLE `vic_session`.`database_patch` (
...
DELIMITER ;;
CREATE PROCEDURE `vic_session`.`fn_test_database_patch`(rev VARCHAR(64))
BEGIN
 DECLARE patchId INT;
...
INSERT INTO `vic_session`.`database_patch`(`revision`, `not_reapplicable`, `note`) VALUES
